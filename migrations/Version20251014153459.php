 ...
 */
final class Version20251014153459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE license_key ADD CONSTRAINT FK_C54B2CFFE9AD6 FOREIGN KEY (orders_id) REFERENCES `order` (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE license_key ADD CONSTRAINT FK_C54B28D9F6D38 FOREIGN KEY (order_id) REFERENCES `order` (id) ON UPDATE NO ACTION ON DELETE SET NULL');
